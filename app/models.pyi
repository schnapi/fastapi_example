...
class UserQuery(Query[User]):
    ...
    def order_by(self, *fields: Literal["email", "-email", "id", "-id", "username", "-username"]) -> "UserQuery":
    ...
    def select(self, *fields: Literal["email", "id", "username"]) -> "UserQuery":
    ...
    def group_by(self, *fields: Literal["email", "id", "username"]) -> "UserQuery":
        """Add GROUP BY clause."""
        ...
    ...
    def values(self, *fields: Literal["email", "id", "username"]) -> "UserQuery":
        """Return dicts instead of models."""
        ...

    def values_list(self, *fields: Literal["email", "id", "username"], flat: bool = False) -> "UserQuery":
